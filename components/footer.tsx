        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://www.instagram.com/selectronyx_tech_hub/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="text-[#94A3B8] transition-all hover:scale-110 hover:text-white"
              >
              ...
              <a
                href="https://www.linkedin.com/company/selectronyx/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="text-[#94A3B8] transition-all hover:scale-110 hover:text-white"
              ...
              <a
                href="https://www.facebook.com/selectronyx"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="text-[#94A3B8] transition-all hover:scale-110 hover:text-white"
